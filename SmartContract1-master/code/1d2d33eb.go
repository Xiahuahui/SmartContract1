...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "(  Term2Bjudge(A))" {
    return FsmEvent(stub, args, "(  Term2Bjudge(A))")
  } else if function == "(  Term2B!judge(A))" {
    return FsmEvent(stub, args, "(  Term2B!judge(A))")
  } else if function == "(Term2B333)" {
    return FsmEvent(stub, args, "(Term2B333)")
  } else if function == "(Term2Btimeout333)" {
    return FsmEvent(stub, args, "(Term2Btimeout333)")
    ...
    return FsmEvent(stub, args, "(  Term1A )")
  } else if function == "(Term1Artrt)" {
    return FsmEvent(stub, args, "(Term1Artrt)")
  } else if function == "(Term1Atimeoutrtrt)" {
    return FsmEvent(stub, args, "(Term1Atimeoutrtrt)")
  } else {
...
func (this *Routers) (  Term2Bjudge(A))((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (  Term2B!judge(A))((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term2B333)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term2Btimeout333)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) (Term1Artrt)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term1Atimeoutrtrt)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

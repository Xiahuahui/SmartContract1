...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "S0" {
    return FsmEvent(stub, args, "S0")
  } else if function == "V0" {
    return FsmEvent(stub, args, "V0")
  } else if function == "S1" {
    return FsmEvent(stub, args, "S1")
  } else if function == "V1" {
    return FsmEvent(stub, args, "V1")
  } else if function == "E2" {
    return FsmEvent(stub, args, "E2")
  } else if function == "E1" {
    return FsmEvent(stub, args, "E1")
  } else if function == "S2" {
    return FsmEvent(stub, args, "S2")
  } else if function == "V2" {
    return FsmEvent(stub, args, "V2")
  } else if function == "E2" {
    return FsmEvent(stub, args, "E2")
  } else if function == "E2" {
    return FsmEvent(stub, args, "E2")
...
func (this *Routers) S0((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) V0((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) S1((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) V1((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) E2((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) E1((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) S2((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) V2((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

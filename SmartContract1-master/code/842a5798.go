...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  } else if function == "(Term0: execute 4545 )" {
    return FsmEvent(stub, args, "(Term0: execute 4545 )")
  } else if function == "(Term0: Violate 4545 )" {
    return FsmEvent(stub, args, "(Term0: Violate 4545 )")
  } else {
...
func (this *Routers) (Term0: execute 4545 )((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term0: Violate 4545 )((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

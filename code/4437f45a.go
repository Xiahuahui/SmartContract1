...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "Ture-324" {
    return FsmEvent(stub, args, "Ture-324")
  } else if function == "Timeout-324" {
    return FsmEvent(stub, args, "Timeout-324")
  } else if function == "Ture-3242" {
    return FsmEvent(stub, args, "Ture-3242")
  } else if function == "Timeout-3242" {
    return FsmEvent(stub, args, "Timeout-3242")
  } else {
...
func (this *Routers) Ture-324((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-324((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Ture-3242((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-3242((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

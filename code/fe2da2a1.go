...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "Ture-42" {
    return FsmEvent(stub, args, "Ture-42")
  } else if function == "Timeout-42" {
    return FsmEvent(stub, args, "Timeout-42")
  } else if function == "Timeout-04" {
    return FsmEvent(stub, args, "Timeout-04")
  } else if function == "Ture-32414" {
    return FsmEvent(stub, args, "Ture-32414")
  } else if function == "Timeout-32414" {
    return FsmEvent(stub, args, "Timeout-32414")
  } else if function == "Timeout-04" {
    return FsmEvent(stub, args, "Timeout-04")
  } else if function == "Ture-04" {
    return FsmEvent(stub, args, "Ture-04")
  } else if function == "Ture-42" {
    return FsmEvent(stub, args, "Ture-42")
  } else if function == "Timeout-42" {
    return FsmEvent(stub, args, "Timeout-42")
  } else if function == "Timeout-04" {
    ...
    return FsmEvent(stub, args, "Timeout-32414")
  } else if function == "Ture-12332" {
    return FsmEvent(stub, args, "Ture-12332")
  } else if function == "Timeout-12332" {
    return FsmEvent(stub, args, "Timeout-12332")
  } else {
...
func (this *Routers) Ture-42((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-42((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) Ture-32414((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-32414((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) Ture-12332((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-12332((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "[["[['A', 'Satpay', 'Term1'], ['A', 'judge(A,4)', 'Term2Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['A', 'Satpay', 'Term1'], ['A', 'judge(A,4)', 'Term2Term2']]"]]")
  } else if function == "[["[['A', 'Satpay', 'Term1'], ['A', '!judge(A,4)', 'Term2Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['A', 'Satpay', 'Term1'], ['A', '!judge(A,4)', 'Term2Term2']]"]]")
  } else if function == "[["[['A', 'Viopay', 'Term1'], ['A', 'judge(A,4)', 'Term2Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['A', 'Viopay', 'Term1'], ['A', 'judge(A,4)', 'Term2Term2']]"]]")
  } else if function == "[["[['A', 'Viopay', 'Term1'], ['A', '!judge(A,4)', 'Term2Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['A', 'Viopay', 'Term1'], ['A', '!judge(A,4)', 'Term2Term2']]"]]")
  } else if function == "[["[['A', 'Satdeliver', 'Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['A', 'Satdeliver', 'Term2']]"]]")
  } else if function == "[["[['A', 'Viodeliver', 'Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['A', 'Viodeliver', 'Term2']]"]]")
  } else if function == "[["[['B', '', 'Term3']]"]]" {
    return FsmEvent(stub, args, "[["[['B', '', 'Term3']]"]]")
  } else if function == "[["[['A', 'Satdeliver', 'Term2'], ['B', '', 'Term3']]"]]" {
    return FsmEvent(stub, args, "[["[['A', 'Satdeliver', 'Term2'], ['B', '', 'Term3']]"]]")
  } else if function == "[["[['A', 'Viodeliver', 'Term2'], ['B', '', 'Term3']]"]]" {
    return FsmEvent(stub, args, "[["[['A', 'Viodeliver', 'Term2'], ['B', '', 'Term3']]"]]")
  } else if function == "[["[['B', '', 'Term3']]"]]" {
    return FsmEvent(stub, args, "[["[['B', '', 'Term3']]"]]")
  } else if function == "[["[['B', '', 'Term3']]"]]" {
    return FsmEvent(stub, args, "[["[['B', '', 'Term3']]"]]")
...
func (this *Routers) [["[['A', 'Satpay', 'Term1'], ['A', 'judge(A,4)', 'Term2Term2']]"]]((stub shim.ChaincodeStubInterface,
...
func (this *Routers) [["[['A', 'Viopay', 'Term1'], ['A', 'judge(A,4)', 'Term2Term2']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) [["[['A', 'Satdeliver', 'Term2']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) [["[['A', 'Viodeliver', 'Term2']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) [["[['A', 'Satdeliver', 'Term2'], ['B', '', 'Term3']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) [["[['A', 'Viodeliver', 'Term2'], ['B', '', 'Term3']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  } else if function == "(Sat1, Sat2)" {
    return FsmEvent(stub, args, "(Sat1, Sat2)")
  } else if function == "(Sat1, Vio2)" {
    return FsmEvent(stub, args, "(Sat1, Vio2)")
  } else if function == "(Vio1, Sat2)" {
    return FsmEvent(stub, args, "(Vio1, Sat2)")
  } else if function == "(Vio1, Vio2)" {
    return FsmEvent(stub, args, "(Vio1, Vio2)")
  } else if function == "(Exp1, Exp2)" {
    return FsmEvent(stub, args, "(Exp1, Exp2)")
  } else {
...
func (this *Routers) (Sat1, Sat2)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Sat1, Vio2)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Vio1, Sat2)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Vio1, Vio2)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Exp1, Exp2)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

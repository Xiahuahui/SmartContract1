...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "[["[['B', 'judge(B,5)', 'Term1Term1']]"]]" {
    return FsmEvent(stub, args, "[["[['B', 'judge(B,5)', 'Term1Term1']]"]]")
  } else if function == "[["[['B', '!judge(B,5)', 'Term1Term1']]"]]" {
    return FsmEvent(stub, args, "[["[['B', '!judge(B,5)', 'Term1Term1']]"]]")
  } else if function == "[["[['A', 'Sat付款', 'Term1']]"]]" {
    return FsmEvent(stub, args, "[["[['A', 'Sat付款', 'Term1']]"]]")
  } else if function == "[["[['A', 'Vio付款', 'Term1']]"]]" {
    return FsmEvent(stub, args, "[["[['A', 'Vio付款', 'Term1']]"]]")
  } else {
...
func (this *Routers) [["[['B', 'judge(B,5)', 'Term1Term1']]"]]((stub shim.ChaincodeStubInterface,
...
func (this *Routers) [["[['A', 'Sat付款', 'Term1']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) [["[['A', 'Vio付款', 'Term1']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

...
contract BCMETH {
    ...
    function (Term0: execute 2323 , Term1: timeout )(String actionStr) public returns(bool){
        if(currentStatus=="[2, 1]" && action=="(Term0: execute 2323 )"){
            currentStatus="[3, 2]";
            return true;
        }
    ...
    function (Term1: execute 6767 )(String actionStr) public returns(bool){
        if(currentStatus=="[2, 1]" && action=="(Term0: execute 2323 )"){
            currentStatus="[3, 2]";
            return true;
        }
    ...
    function (Term1: Violate 6767 )(String actionStr) public returns(bool){
        if(currentStatus=="[2, 1]" && action=="(Term0: execute 2323 )"){
            currentStatus="[3, 2]";
            return true;
        }

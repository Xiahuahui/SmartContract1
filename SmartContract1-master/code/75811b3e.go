...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "(Term0: execute 23)" {
    return FsmEvent(stub, args, "(Term0: execute 23)")
  } else if function == "(Term0: Violate 23)" {
    return FsmEvent(stub, args, "(Term0: Violate 23)")
  } else if function == "(Term1: execute 34)" {
    return FsmEvent(stub, args, "(Term1: execute 34)")
  } else if function == "(Term1: Violate 34)" {
    return FsmEvent(stub, args, "(Term1: Violate 34)")
  } else if function == "(Term1: timeout)" {
    return FsmEvent(stub, args, "(Term1: timeout)")
  } else if function == "(Term2: execute 565)" {
    return FsmEvent(stub, args, "(Term2: execute 565)")
  } else if function == "(Term2: Violate 565)" {
    return FsmEvent(stub, args, "(Term2: Violate 565)")
...
func (this *Routers) (Term0: execute 23)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term0: Violate 23)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term1: execute 34)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term1: Violate 34)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) (Term2: execute 565)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term2: Violate 565)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

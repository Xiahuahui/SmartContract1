...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "Ture-fsd" {
    return FsmEvent(stub, args, "Ture-fsd")
  } else if function == "Timeout-fsd" {
    return FsmEvent(stub, args, "Timeout-fsd")
  } else if function == "Ture-发顺丰" {
    return FsmEvent(stub, args, "Ture-发顺丰")
  } else if function == "Timeout-发顺丰" {
    return FsmEvent(stub, args, "Timeout-发顺丰")
  } else {
...
func (this *Routers) Ture-fsd((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-fsd((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Ture-发顺丰((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-发顺丰((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "(Term0: execute 1212, Term1: execute 1212)" {
    return FsmEvent(stub, args, "(Term0: execute 1212, Term1: execute 1212)")
  } else if function == "(Term0: Violate1212, Term1: execute 1212)" {
    return FsmEvent(stub, args, "(Term0: Violate1212, Term1: execute 1212)")
  } else {
...
func (this *Routers) (Term0: execute 1212, Term1: execute 1212)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term0: Violate1212, Term1: execute 1212)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

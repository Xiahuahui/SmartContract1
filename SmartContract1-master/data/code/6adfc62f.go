...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "[A]预存100元书款" {
    return FsmEvent(stub, args, "[A]预存100元书款")
  } else if function == "[A]预存100元书款超时" {
    return FsmEvent(stub, args, "[A]预存100元书款超时")
  } else if function == "" {
    return FsmEvent(stub, args, "")
  } else if function == "" {
    return FsmEvent(stub, args, "")
  } else if function == "[B]给李华发送书籍" {
    return FsmEvent(stub, args, "[B]给李华发送书籍")
  } else if function == "[B]给李华发送书籍超时" {
    return FsmEvent(stub, args, "[B]给李华发送书籍超时")
  } else if function == "" {
    return FsmEvent(stub, args, "")
  } else if function == "" {
    return FsmEvent(stub, args, "")
    ...
    return FsmEvent(stub, args, "")
  } else if function == "[A]李华确认收货" {
    return FsmEvent(stub, args, "[A]李华确认收货")
  } else if function == "[A]李华确认收货超时" {
    return FsmEvent(stub, args, "[A]李华确认收货超时")
  } else if function == "[C]将书款返还给李华" {
    return FsmEvent(stub, args, "[C]将书款返还给李华")
  } else if function == "" {
    return FsmEvent(stub, args, "")
  } else if function == "" {
    return FsmEvent(stub, args, "")
  } else if function == "[C]将书款转给书店" {
    return FsmEvent(stub, args, "[C]将书款转给书店")
  } else {
...
func (this *Routers) [A]预存100元书款((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) [A]预存100元书款超时((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) [B]给李华发送书籍((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) [B]给李华发送书籍超时((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) [A]李华确认收货((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) [A]李华确认收货超时((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) [C]将书款返还给李华((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) [C]将书款转给书店((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

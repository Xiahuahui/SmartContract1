...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "(Term0: execute 232, Term1: execute 32323)" {
    return FsmEvent(stub, args, "(Term0: execute 232, Term1: execute 32323)")
  } else if function == "(Term0: execute 232, Term1: Violate32323)" {
    return FsmEvent(stub, args, "(Term0: execute 232, Term1: Violate32323)")
  } else if function == "(Term0: Violate232, Term1: execute 32323)" {
    return FsmEvent(stub, args, "(Term0: Violate232, Term1: execute 32323)")
  } else if function == "(Term0: Violate232, Term1: Violate32323)" {
    return FsmEvent(stub, args, "(Term0: Violate232, Term1: Violate32323)")
  } else {
...
func (this *Routers) (Term0: execute 232, Term1: execute 32323)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term0: execute 232, Term1: Violate32323)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term0: Violate232, Term1: execute 32323)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term0: Violate232, Term1: Violate32323)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

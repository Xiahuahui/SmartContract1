...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "[["[['A', 'Satdeposit(A,Contract,100)', 'Term1']]"]]" {
    return FsmEvent(stub, args, "[["[['A', 'Satdeposit(A,Contract,100)', 'Term1']]"]]")
  } else if function == "[["[['A', 'Viodeposit(A,Contract,100)', 'Term1']]"]]" {
    return FsmEvent(stub, args, "[["[['A', 'Viodeposit(A,Contract,100)', 'Term1']]"]]")
  } else if function == "[["[['B', '', 'Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['B', '', 'Term2']]"]]")
  } else if function == "[["[['B', '', 'Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['B', '', 'Term2']]"]]")
  } else if function == "[["[['B', 'Satdeliver(B,A,book)', 'Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['B', 'Satdeliver(B,A,book)', 'Term2']]"]]")
  } else if function == "[["[['B', 'Viodeliver(B,A,book)', 'Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['B', 'Viodeliver(B,A,book)', 'Term2']]"]]")
    ...
    return FsmEvent(stub, args, "[["[['A', '', 'Term3']]"]]")
  } else if function == "[["[['A', 'Satconfirm(A,book)', 'Term3']]"]]" {
    return FsmEvent(stub, args, "[["[['A', 'Satconfirm(A,book)', 'Term3']]"]]")
  } else if function == "[["[['A', 'Vioconfirm(A,book)', 'Term3']]"]]" {
    return FsmEvent(stub, args, "[["[['A', 'Vioconfirm(A,book)', 'Term3']]"]]")
  } else {
...
func (this *Routers) [["[['A', 'Satdeposit(A,Contract,100)', 'Term1']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) [["[['A', 'Viodeposit(A,Contract,100)', 'Term1']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) [["[['B', 'Satdeliver(B,A,book)', 'Term2']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) [["[['B', 'Viodeliver(B,A,book)', 'Term2']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) [["[['A', 'Satconfirm(A,book)', 'Term3']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) [["[['A', 'Vioconfirm(A,book)', 'Term3']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

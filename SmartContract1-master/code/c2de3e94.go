...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "(Sat0, Sat1, Sat2)" {
    return FsmEvent(stub, args, "(Sat0, Sat1, Sat2)")
  } else if function == "(Sat0, Sat1, Vio2)" {
    return FsmEvent(stub, args, "(Sat0, Sat1, Vio2)")
  } else if function == "(Sat0, Vio1, Sat2)" {
    return FsmEvent(stub, args, "(Sat0, Vio1, Sat2)")
  } else if function == "(Sat0, Vio1, Vio2)" {
    return FsmEvent(stub, args, "(Sat0, Vio1, Vio2)")
  } else if function == "(Vio0, Sat1, Sat2)" {
    return FsmEvent(stub, args, "(Vio0, Sat1, Sat2)")
  } else if function == "(Vio0, Sat1, Vio2)" {
    return FsmEvent(stub, args, "(Vio0, Sat1, Vio2)")
  } else if function == "(Vio0, Vio1, Sat2)" {
    return FsmEvent(stub, args, "(Vio0, Vio1, Sat2)")
  } else if function == "(Vio0, Vio1, Vio2)" {
    return FsmEvent(stub, args, "(Vio0, Vio1, Vio2)")
  } else {
...
func (this *Routers) (Sat0, Sat1, Sat2)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Sat0, Sat1, Vio2)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Sat0, Vio1, Sat2)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Sat0, Vio1, Vio2)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Vio0, Sat1, Sat2)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Vio0, Sat1, Vio2)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Vio0, Vio1, Sat2)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Vio0, Vio1, Vio2)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

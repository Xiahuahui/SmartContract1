...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "(Sat0, Sat1)" {
    return FsmEvent(stub, args, "(Sat0, Sat1)")
  } else if function == "(Sat0, Vio1)" {
    return FsmEvent(stub, args, "(Sat0, Vio1)")
  } else if function == "(Vio0, Sat1)" {
    return FsmEvent(stub, args, "(Vio0, Sat1)")
  } else if function == "(Vio0, Vio1)" {
    return FsmEvent(stub, args, "(Vio0, Vio1)")
...
func (this *Routers) (Sat0, Sat1)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Sat0, Vio1)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Vio0, Sat1)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Vio0, Vio1)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

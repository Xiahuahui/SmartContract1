...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "(Term0: execute 预付款)" {
    return FsmEvent(stub, args, "(Term0: execute 预付款)")
  } else if function == "(Term0: Violate预付款)" {
    return FsmEvent(stub, args, "(Term0: Violate预付款)")
  } else if function == "(Term1: execute 发货)" {
    return FsmEvent(stub, args, "(Term1: execute 发货)")
  } else if function == "(Term1: Violate发货)" {
    return FsmEvent(stub, args, "(Term1: Violate发货)")
  } else if function == "(Term1: timeout)" {
    return FsmEvent(stub, args, "(Term1: timeout)")
  } else if function == "(Term2: execute 确认, Term4: timeout)" {
    return FsmEvent(stub, args, "(Term2: execute 确认, Term4: timeout)")
  } else if function == "(Term2: Violate确认, Term4: timeout)" {
    return FsmEvent(stub, args, "(Term2: Violate确认, Term4: timeout)")
  } else if function == "(Term2: timeout, Term4: execute 回退)" {
    return FsmEvent(stub, args, "(Term2: timeout, Term4: execute 回退)")
  } else if function == "(Term2: timeout, Term4: timeout)" {
    return FsmEvent(stub, args, "(Term2: timeout, Term4: timeout)")
  } else if function == "(Term3: execute 转账)" {
    return FsmEvent(stub, args, "(Term3: execute 转账)")
...
func (this *Routers) (Term0: execute 预付款)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term0: Violate预付款)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) (Term1: Violate发货)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) (Term2: execute 确认, Term4: timeout)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term2: Violate确认, Term4: timeout)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term2: timeout, Term4: execute 回退)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term2: timeout, Term4: timeout)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term3: execute 转账)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

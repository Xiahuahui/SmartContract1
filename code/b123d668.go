...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "Ture-ert" {
    return FsmEvent(stub, args, "Ture-ert")
  } else if function == "Timeout-ert" {
    return FsmEvent(stub, args, "Timeout-ert")
  } else if function == "Ture-rtewt" {
    return FsmEvent(stub, args, "Ture-rtewt")
  } else if function == "Timeoutrtewt" {
    return FsmEvent(stub, args, "Timeoutrtewt")
  } else {
...
func (this *Routers) Ture-ert((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-ert((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Ture-rtewt((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeoutrtewt((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

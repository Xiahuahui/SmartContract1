...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "Ture-sdf" {
    return FsmEvent(stub, args, "Ture-sdf")
  } else if function == "Timeout-sdf" {
    return FsmEvent(stub, args, "Timeout-sdf")
  } else if function == "Timeout-03" {
    return FsmEvent(stub, args, "Timeout-03")
  } else if function == "Ture-dfd" {
    return FsmEvent(stub, args, "Ture-dfd")
  } else if function == "Timeout-dfd" {
    return FsmEvent(stub, args, "Timeout-dfd")
    ...
    return FsmEvent(stub, args, "Timeout-03")
  } else if function == "Ture-f" {
    return FsmEvent(stub, args, "Ture-f")
  } else if function == "Timeout-f" {
    return FsmEvent(stub, args, "Timeout-f")
  } else if function == "Ture-dfd" {
    return FsmEvent(stub, args, "Ture-dfd")
  } else if function == "Timeout-dfd" {
    return FsmEvent(stub, args, "Timeout-dfd")
...
func (this *Routers) Ture-sdf((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-sdf((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) Ture-dfd((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-dfd((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) Ture-f((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-f((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

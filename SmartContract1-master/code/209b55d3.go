...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "(Term0: execute 9999 )" {
    return FsmEvent(stub, args, "(Term0: execute 9999 )")
  } else if function == "(Term0: Violate 9999 )" {
    return FsmEvent(stub, args, "(Term0: Violate 9999 )")
...
func (this *Routers) (Term0: execute 9999 )((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term0: Violate 9999 )((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  } else if function == "(Term0: Violate 预付金)" {
    return FsmEvent(stub, args, "(Term0: Violate 预付金)")
  } else if function == "(Term1: execute 生产货物)" {
    return FsmEvent(stub, args, "(Term1: execute 生产货物)")
  } else if function == "(Term1: Violate 生产货物)" {
    return FsmEvent(stub, args, "(Term1: Violate 生产货物)")
  ...
  } else if function == "(Term2: execute 惩罚操作 ,Term3: Violate 运送货物)" {
    return FsmEvent(stub, args, "(Term2: execute 惩罚操作 ,Term3: Violate 运送货物)")
  ...
  } else if function == "(Term2: timeout ,Term3: timeout ,Term7: execute intel退还押金并惩罚)" {
    return FsmEvent(stub, args, "(Term2: timeout ,Term3: timeout ,Term7: execute intel退还押金并惩罚)")
  } else if function == "(Term3: execute 运送货物)" {
    return FsmEvent(stub, args, "(Term3: execute 运送货物)")
  } else if function == "(Term3: Violate 运送货物)" {
    return FsmEvent(stub, args, "(Term3: Violate 运送货物)")
  ...
  } else if function == "(Term4: Violate 换货 ,Term7: timeout)" {
    return FsmEvent(stub, args, "(Term4: Violate 换货 ,Term7: timeout)")
  } else if function == "(Term4: timeout ,Term7: execute intel退还押金并惩罚)" {
    return FsmEvent(stub, args, "(Term4: timeout ,Term7: execute intel退还押金并惩罚)")
  } else if function == "(Term5: timeout ,Term6: execute Lenovo付款 ,Term7: timeout)" {
    return FsmEvent(stub, args, "(Term5: timeout ,Term6: execute Lenovo付款 ,Term7: timeout)")
  } else if function == "(Term5: timeout ,Term6: Violate Lenovo付款 ,Term7: timeout)" {
    return FsmEvent(stub, args, "(Term5: timeout ,Term6: Violate Lenovo付款 ,Term7: timeout)")
  ...
  } else if function == "(Term5: timeout ,Term6: execute Lenovo付款)" {
    return FsmEvent(stub, args, "(Term5: timeout ,Term6: execute Lenovo付款)")
  } else if function == "(Term5: timeout ,Term6: Violate Lenovo付款)" {
    return FsmEvent(stub, args, "(Term5: timeout ,Term6: Violate Lenovo付款)")
  } else if function == "(Term5: execute 违约操作 ,Term6: timeout)" {
    return FsmEvent(stub, args, "(Term5: execute 违约操作 ,Term6: timeout)")
...
func (this *Routers) (Term0: Violate 预付金)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) (Term1: Violate 生产货物)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) (Term2: execute 惩罚操作 ,Term3: Violate 运送货物)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) (Term2: timeout ,Term3: timeout ,Term7: execute intel退还押金并惩罚)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) (Term3: Violate 运送货物)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) (Term4: Violate 换货 ,Term7: timeout)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term4: timeout ,Term7: execute intel退还押金并惩罚)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term5: timeout ,Term6: execute Lenovo付款 ,Term7: timeout)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term5: timeout ,Term6: Violate Lenovo付款 ,Term7: timeout)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) (Term5: timeout ,Term6: execute Lenovo付款)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term5: timeout ,Term6: Violate Lenovo付款)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term5: execute 违约操作 ,Term6: timeout)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

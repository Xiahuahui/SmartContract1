...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "Ture-grtgrt" {
    return FsmEvent(stub, args, "Ture-grtgrt")
  } else if function == "Timeout-grtgrt" {
    return FsmEvent(stub, args, "Timeout-grtgrt")
  } else if function == "Ture-rtrte" {
    return FsmEvent(stub, args, "Ture-rtrte")
  } else if function == "Timeout-rtrte" {
    return FsmEvent(stub, args, "Timeout-rtrte")
  } else {
...
func (this *Routers) Ture-grtgrt((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-grtgrt((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Ture-rtrte((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-rtrte((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

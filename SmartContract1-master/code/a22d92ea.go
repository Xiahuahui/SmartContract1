...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "(Term0: execute 34)" {
    return FsmEvent(stub, args, "(Term0: execute 34)")
  } else if function == "(Term0: Violate34)" {
    return FsmEvent(stub, args, "(Term0: Violate34)")
  } else {
...
func (this *Routers) (Term0: execute 34)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term0: Violate34)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

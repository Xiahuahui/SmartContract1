...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "Ture-w" {
    return FsmEvent(stub, args, "Ture-w")
  } else if function == "Timeout-w" {
    return FsmEvent(stub, args, "Timeout-w")
  } else if function == "Ture-缴纳房租" {
    return FsmEvent(stub, args, "Ture-缴纳房租")
  } else if function == "Timeout-缴纳房租" {
    return FsmEvent(stub, args, "Timeout-缴纳房租")
  } else {
...
func (this *Routers) Ture-w((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-w((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Ture-缴纳房租((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-缴纳房租((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

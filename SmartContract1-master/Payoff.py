...
class Path:
     ...
     def getPathChoices(self):
         ...
         for ce in self._compEdges:
             edgeChoiceA, edgeChoiceB = ce.getAllChoices()  # TODO we need to add nodeID into CompositeEdge
             pathChoiceA.append(edgeChoiceA)
             pathChoiceB.append(edgeChoiceB)
         pathChoiceA = Choice.removeDupChoices(pathChoiceA)
         pathChoiceB = Choice.removeDupChoices(pathChoiceB)
         print("length of choices:" , len(pathChoiceA), len(pathChoiceB))
     ...
     def findUtility(self, straA, straB):
         ...
         print("straB.contain(pathChoicesB): ",straA.contain(pathChoicesA))
         print("straA.contain(pathChoicesA): ",straA.contain(pathChoicesA))
         print("straA.contain(pathChoicesA) and straB.contain(pathChoicesB):  ",straA.contain(pathChoicesA) and straB.contain(pathChoicesB))

...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "Ture-aas" {
    return FsmEvent(stub, args, "Ture-aas")
  } else if function == "Timeout-aas" {
    return FsmEvent(stub, args, "Timeout-aas")
  } else if function == "Ture-assault" {
    return FsmEvent(stub, args, "Ture-assault")
  } else if function == "Timeout-assault" {
    return FsmEvent(stub, args, "Timeout-assault")
  } else {
...
func (this *Routers) Ture-aas((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-aas((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Ture-assault((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-assault((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "Ture-vvvv" {
    return FsmEvent(stub, args, "Ture-vvvv")
  } else if function == "Timeout-vvvv" {
    return FsmEvent(stub, args, "Timeout-vvvv")
    ...
    return FsmEvent(stub, args, "Timeout-03")
  } else if function == "Ture-vvvv" {
    return FsmEvent(stub, args, "Ture-vvvv")
  } else if function == "Timeout-vvvv" {
    return FsmEvent(stub, args, "Timeout-vvvv")
  } else if function == "Ture-cvcv" {
    return FsmEvent(stub, args, "Ture-cvcv")
  } else if function == "Timeout-cvcv" {
    return FsmEvent(stub, args, "Timeout-cvcv")
  } else {
...
func (this *Routers) Ture-vvvv((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-vvvv((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) Ture-cvcv((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-cvcv((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

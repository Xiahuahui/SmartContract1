...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "(Term1: execute  )" {
    return FsmEvent(stub, args, "(Term1: execute  )")
  } else if function == "(Term1: Violate  )" {
    return FsmEvent(stub, args, "(Term1: Violate  )")
  } else if function == "(Term0: execute  )" {
    return FsmEvent(stub, args, "(Term0: execute  )")
  } else if function == "(Term0: Violate  )" {
    return FsmEvent(stub, args, "(Term0: Violate  )")
...
func (this *Routers) (Term0: execute  )((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term0: Violate  )((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

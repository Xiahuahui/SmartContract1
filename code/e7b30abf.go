...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "Ture-werq" {
    return FsmEvent(stub, args, "Ture-werq")
  } else if function == "Timeout-werq" {
    return FsmEvent(stub, args, "Timeout-werq")
  } else if function == "Timeout-03" {
    return FsmEvent(stub, args, "Timeout-03")
  } else if function == "Timeout-14" {
    return FsmEvent(stub, args, "Timeout-14")
  } else if function == "Ture-ereqw" {
    return FsmEvent(stub, args, "Ture-ereqw")
  } else if function == "Timeout-ereqw" {
    return FsmEvent(stub, args, "Timeout-ereqw")
  } else if function == "Timeout-03" {
    return FsmEvent(stub, args, "Timeout-03")
  } else if function == "Timeout-14" {
    return FsmEvent(stub, args, "Timeout-14")
    ...
    return FsmEvent(stub, args, "Timeout-14")
  } else if function == "Ture-werq" {
    return FsmEvent(stub, args, "Ture-werq")
  } else if function == "Timeout-werq" {
    return FsmEvent(stub, args, "Timeout-werq")
  } else if function == "Ture-14" {
    return FsmEvent(stub, args, "Ture-14")
  } else if function == "Ture-werq" {
    return FsmEvent(stub, args, "Ture-werq")
  } else if function == "Timeout-werq" {
    return FsmEvent(stub, args, "Timeout-werq")
    ...
    return FsmEvent(stub, args, "Timeout-werq")
  } else if function == "Ture-wreq" {
    return FsmEvent(stub, args, "Ture-wreq")
  } else if function == "Timeout-wreq" {
    return FsmEvent(stub, args, "Timeout-wreq")
  } else if function == "Ture-werq" {
    return FsmEvent(stub, args, "Ture-werq")
  } else if function == "Timeout-werq" {
    return FsmEvent(stub, args, "Timeout-werq")
  } else if function == "Ture-qwerqr" {
    return FsmEvent(stub, args, "Ture-qwerqr")
  } else if function == "Timeout-qwerqr" {
    return FsmEvent(stub, args, "Timeout-qwerqr")
  } else if function == "Timeout-14" {
    return FsmEvent(stub, args, "Timeout-14")
  } else if function == "Ture-03" {
    return FsmEvent(stub, args, "Ture-03")
...
func (this *Routers) Ture-werq((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-werq((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) Timeout-14((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Ture-ereqw((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-ereqw((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) Ture-14((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) Ture-wreq((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-wreq((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) Ture-qwerqr((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-qwerqr((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "Ture-rrr" {
    return FsmEvent(stub, args, "Ture-rrr")
  } else if function == "Timeout-rrr" {
    return FsmEvent(stub, args, "Timeout-rrr")
  } else if function == "Ture-二二" {
    return FsmEvent(stub, args, "Ture-二二")
  } else if function == "Timeout-二二" {
    return FsmEvent(stub, args, "Timeout-二二")
  } else {
...
func (this *Routers) Ture-rrr((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-rrr((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Ture-二二((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-二二((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "[["[['B', 'Sat二二', 'Term1']]"]]" {
    return FsmEvent(stub, args, "[["[['B', 'Sat二二', 'Term1']]"]]")
  } else if function == "[["[['B', 'Vio二二', 'Term1']]"]]" {
    return FsmEvent(stub, args, "[["[['B', 'Vio二二', 'Term1']]"]]")
  } else if function == "[["[['A', '', 'Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['A', '', 'Term2']]"]]")
  } else if function == "[["[['A', '', 'Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['A', '', 'Term2']]"]]")
  } else if function == "[["[['A', 'Sat', 'Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['A', 'Sat', 'Term2']]"]]")
  } else if function == "[["[['A', 'Vio', 'Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['A', 'Vio', 'Term2']]"]]")
  } else {
...
func (this *Routers) [["[['A', '', 'Term2']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) [["[['A', 'Sat', 'Term2']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) [["[['A', 'Vio', 'Term2']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

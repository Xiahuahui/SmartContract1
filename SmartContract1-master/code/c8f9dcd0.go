...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "(Term1Ajudge(A,2))" {
    return FsmEvent(stub, args, "(Term1Ajudge(A,2))")
  } else if function == "(Term1A!judge(A,2))" {
    return FsmEvent(stub, args, "(Term1A!judge(A,2))")
  } else if function == "(Term1Asatvcgfg)" {
    return FsmEvent(stub, args, "(Term1Asatvcgfg)")
  } else if function == "(Term1Aviovcgfg)" {
    return FsmEvent(stub, args, "(Term1Aviovcgfg)")
  } else {
...
func (this *Routers) (Term1Ajudge(A,2))((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term1A!judge(A,2))((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term1Asatvcgfg)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term1Aviovcgfg)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

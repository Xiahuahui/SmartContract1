...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "Ture-we" {
    return FsmEvent(stub, args, "Ture-we")
  } else if function == "Timeout-we" {
    return FsmEvent(stub, args, "Timeout-we")
  } else if function == "Ture-玩儿翁" {
    return FsmEvent(stub, args, "Ture-玩儿翁")
  } else if function == "Timeout-玩儿翁" {
    return FsmEvent(stub, args, "Timeout-玩儿翁")
  } else {
...
func (this *Routers) Ture-we((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-we((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Ture-玩儿翁((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-玩儿翁((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

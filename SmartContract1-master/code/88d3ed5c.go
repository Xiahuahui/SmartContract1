...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "Ture-sAS" {
    return FsmEvent(stub, args, "Ture-sAS")
  } else if function == "Timeout-sAS" {
    return FsmEvent(stub, args, "Timeout-sAS")
  } else if function == "Ture-ASAS" {
    return FsmEvent(stub, args, "Ture-ASAS")
  } else if function == "Timeout-ASAS" {
    return FsmEvent(stub, args, "Timeout-ASAS")
  } else {
...
func (this *Routers) Ture-sAS((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-sAS((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Ture-ASAS((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-ASAS((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  } else if function == "(Term1: execute 3434)" {
    return FsmEvent(stub, args, "(Term1: execute 3434)")
  } else if function == "(Term1: Violate 3434)" {
    return FsmEvent(stub, args, "(Term1: Violate 3434)")
...
func (this *Routers) (Term1: execute 3434)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term1: Violate 3434)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "Ture-gdsfg" {
    return FsmEvent(stub, args, "Ture-gdsfg")
  } else if function == "Timeout-gdsfg" {
    return FsmEvent(stub, args, "Timeout-gdsfg")
  } else if function == "Ture-gdfgs" {
    return FsmEvent(stub, args, "Ture-gdfgs")
  } else if function == "Timeout-gdfgs" {
    return FsmEvent(stub, args, "Timeout-gdfgs")
  } else if function == "Ture-奋斗故事大概" {
    return FsmEvent(stub, args, "Ture-奋斗故事大概")
  } else if function == "Timeout-奋斗故事大概" {
    return FsmEvent(stub, args, "Timeout-奋斗故事大概")
  } else if function == "Ture-gdfgs" {
    return FsmEvent(stub, args, "Ture-gdfgs")
  } else if function == "Timeout-gdfgs" {
    return FsmEvent(stub, args, "Timeout-gdfgs")
    ...
    return FsmEvent(stub, args, "Timeout-gdfgs")
  } else if function == "Ture-gdsfg" {
    return FsmEvent(stub, args, "Ture-gdsfg")
  } else if function == "Timeout-gdsfg" {
    return FsmEvent(stub, args, "Timeout-gdsfg")
  } else if function == "Ture-对方告诉大哥" {
    return FsmEvent(stub, args, "Ture-对方告诉大哥")
  } else if function == "Timeout-对方告诉大哥" {
    return FsmEvent(stub, args, "Timeout-对方告诉大哥")
  } else if function == "Ture-gdsfg" {
    return FsmEvent(stub, args, "Ture-gdsfg")
  } else if function == "Timeout-gdsfg" {
    return FsmEvent(stub, args, "Timeout-gdsfg")
...
func (this *Routers) Ture-gdsfg((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-gdsfg((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Ture-gdfgs((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-gdfgs((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Ture-奋斗故事大概((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-奋斗故事大概((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) Ture-对方告诉大哥((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-对方告诉大哥((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

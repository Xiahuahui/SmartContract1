...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "Ture-vxc" {
    return FsmEvent(stub, args, "Ture-vxc")
  } else if function == "Timeout-vxc" {
    return FsmEvent(stub, args, "Timeout-vxc")
  } else if function == "Ture-程序V型" {
    return FsmEvent(stub, args, "Ture-程序V型")
  } else if function == "Timeout-程序V型" {
    return FsmEvent(stub, args, "Timeout-程序V型")
  } else {
...
func (this *Routers) Ture-vxc((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-vxc((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Ture-程序V型((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-程序V型((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

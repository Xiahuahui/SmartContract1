...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  } else if function == "(Term1: execute 45465)" {
    return FsmEvent(stub, args, "(Term1: execute 45465)")
  } else if function == "(Term1: Violate 45465)" {
    return FsmEvent(stub, args, "(Term1: Violate 45465)")
...
func (this *Routers) (Term1: execute 45465)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term1: Violate 45465)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

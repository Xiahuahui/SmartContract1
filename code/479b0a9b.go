...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "Ture-rew" {
    return FsmEvent(stub, args, "Ture-rew")
  } else if function == "Timeout-rew" {
    return FsmEvent(stub, args, "Timeout-rew")
  } else if function == "Ture-玩儿" {
    return FsmEvent(stub, args, "Ture-玩儿")
  } else if function == "Timeout-玩儿" {
    return FsmEvent(stub, args, "Timeout-玩儿")
  } else {
...
func (this *Routers) Ture-rew((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-rew((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Ture-玩儿((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-玩儿((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

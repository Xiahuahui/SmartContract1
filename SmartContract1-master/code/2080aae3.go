...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "Ture-21321" {
    return FsmEvent(stub, args, "Ture-21321")
  } else if function == "Timeout-21321" {
    return FsmEvent(stub, args, "Timeout-21321")
  } else if function == "Timeout-04" {
    return FsmEvent(stub, args, "Timeout-04")
  } else if function == "Ture-1231" {
    return FsmEvent(stub, args, "Ture-1231")
  } else if function == "Timeout-1231" {
    return FsmEvent(stub, args, "Timeout-1231")
  } else if function == "Timeout-04" {
    return FsmEvent(stub, args, "Timeout-04")
  } else if function == "Ture-04" {
    return FsmEvent(stub, args, "Ture-04")
  } else if function == "Ture-21321" {
    return FsmEvent(stub, args, "Ture-21321")
  } else if function == "Timeout-21321" {
    return FsmEvent(stub, args, "Timeout-21321")
  } else if function == "Timeout-04" {
    ...
    return FsmEvent(stub, args, "Timeout-1231")
  } else if function == "Ture-213421" {
    return FsmEvent(stub, args, "Ture-213421")
  } else if function == "Timeout-213421" {
    return FsmEvent(stub, args, "Timeout-213421")
  } else {
...
func (this *Routers) Ture-21321((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-21321((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) Ture-1231((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-1231((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) Ture-213421((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-213421((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

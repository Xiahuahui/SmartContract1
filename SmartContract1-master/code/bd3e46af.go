...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "[["[['A', 'Sat阿萨所]', 'Term1']]"]]" {
    return FsmEvent(stub, args, "[["[['A', 'Sat阿萨所]', 'Term1']]"]]")
  } else if function == "[["[['A', 'Vio阿萨所]', 'Term1']]"]]" {
    return FsmEvent(stub, args, "[["[['A', 'Vio阿萨所]', 'Term1']]"]]")
  } else if function == "[["[['B', '', 'Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['B', '', 'Term2']]"]]")
  } else if function == "[["[['C', 'judge(C,A)', 'Term2Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['C', 'judge(C,A)', 'Term2Term2']]"]]")
  } else if function == "[["[['C', '!judge(C,A)', 'Term2Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['C', '!judge(C,A)', 'Term2Term2']]"]]")
  } else if function == "[["[['B', 'Sat', 'Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['B', 'Sat', 'Term2']]"]]")
  } else if function == "[["[['B', 'Vio', 'Term2']]"]]" {
    return FsmEvent(stub, args, "[["[['B', 'Vio', 'Term2']]"]]")
  } else {
...
func (this *Routers) [["[['A', 'Sat阿萨所]', 'Term1']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) [["[['A', 'Vio阿萨所]', 'Term1']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) [["[['C', 'judge(C,A)', 'Term2Term2']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) [["[['B', 'Sat', 'Term2']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) [["[['B', 'Vio', 'Term2']]"]]((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

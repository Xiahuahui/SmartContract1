...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "Ture-das" {
    return FsmEvent(stub, args, "Ture-das")
  } else if function == "Timeout-das" {
    return FsmEvent(stub, args, "Timeout-das")
  } else if function == "Ture-撒大声地" {
    return FsmEvent(stub, args, "Ture-撒大声地")
  } else if function == "Timeout-撒大声地" {
    return FsmEvent(stub, args, "Timeout-撒大声地")
  } else {
...
func (this *Routers) Ture-das((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-das((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Ture-撒大声地((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) Timeout-撒大声地((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}

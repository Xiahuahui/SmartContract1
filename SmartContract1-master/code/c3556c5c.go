...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "(Term1: execute 2323)" {
    return FsmEvent(stub, args, "(Term1: execute 2323)")
  } else if function == "(Term1: Violate 2323)" {
    return FsmEvent(stub, args, "(Term1: Violate 2323)")
  } else if function == "(Term0: execute 4)" {
    return FsmEvent(stub, args, "(Term0: execute 4)")
  } else if function == "(Term0: Violate 4)" {
    return FsmEvent(stub, args, "(Term0: Violate 4)")
  } else if function == "(Term0: timeout)" {
    return FsmEvent(stub, args, "(Term0: timeout)")
  } else {
...
func (this *Routers) (Term1: execute 2323)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term1: Violate 2323)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term0: execute 4)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term0: Violate 4)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) (Term0: timeout)((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
